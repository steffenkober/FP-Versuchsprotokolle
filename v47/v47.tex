...
\title{V47 - Molwärme von Cu}
\date{Durchführung: 24.04.2023 \hspace{3em} Abgabe: 05.05.2023}


% tu logo on top of the titlepage
\titlehead{\includegraphics[height=1.5cm]{../tu-logo.pdf}}
...
\input{content/01_zielsetzung.tex}
\input{content/02_theorie.tex}
\input{content/03_durchfuehrung.tex}
\input{content/04_auswertung.tex}
\input{content/05_diskussion.tex}
%\mainmatter
%\newpage
